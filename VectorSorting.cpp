...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        case 2:
            ...
            size_t subtract = 1; //declared this variable to fix type conversion error between size_t & int
            quickSort(bids, 0, bids.size() - subtract);
        }
    }
